...
public class QuestIcon : MonoBehaviour
{
    ...
    [SerializeField] private GameObject nextStepIcon;

    private GameObject[] icons;

    private void Awake()
    {
        icons = new GameObject[5] { requirementsNotMetToStartIcon, canStartIcon, requirementsNotMetToFinishIcon, canFinishIcon, nextStepIcon };
    }
